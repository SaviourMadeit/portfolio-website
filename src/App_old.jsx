				...
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-16 animate-in slide-in-from-bottom duration-700">
						...
						<p
							className={`text-xl max-w-2xl mx-auto ${isDark ? "text-gray-400" : "text-gray-600"}`}
						>
							Pushing boundaries in IC design and silicon
							engineering
						</p>
					</div>
								...
								<div className="space-y-6">
									<div>
										...
										>
											...
											Circuit (ASIC) optimized for IoT
											sensor data processing and edge AI
											inference in agricultural systems.
										</p>
									</div>
						...
						{blogPosts.map((post, index) => (
							...
							>
								...
								<div className="relative h-48 overflow-hidden">
									...
									/>
									<div
										className={`absolute inset-0 bg-linear-to-br ${post.gradient} opacity-40 group-hover:opacity-30 transition-opacity`}
									/>
				...
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-16 animate-in slide-in-from-bottom duration-700">
						...
						<p
							className={`text-xl max-w-2xl mx-auto ${isDark ? "text-gray-400" : "text-gray-600"}`}
						>
							Testimonials from mentors, colleagues, and those
							I've helped
						</p>
					</div>
				...
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-16 animate-in slide-in-from-bottom duration-700">
						...
						<p
							className={`text-xl max-w-2xl mx-auto ${isDark ? "text-gray-400" : "text-gray-600"}`}
						>
							Comprehensive skills across the embedded systems
							stack
						</p>
					</div>
				...
				<div className="max-w-4xl mx-auto">
					...
					>
						<div className="relative text-center space-y-8 mb-12">
							...
							<div>
								...
								>
									Have questions or want to collaborate? Fill
					...
					>
						...
						<div className="relative text-center space-y-8">
							...
							>
								Have a project in mind? Looking for
								collaboration opportunities? I'm always excited
								to work on innovative embedded systems projects.
							</p>
				...
				<div className="max-w-7xl mx-auto">
					<div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
						...
						<div className="text-center">
							...
							>
								"Building the bridge between software and
								silicon"
							</p>
							<p
								className={`text-sm ${
